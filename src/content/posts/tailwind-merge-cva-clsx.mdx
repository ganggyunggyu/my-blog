...
**추가 클래스를 부여해준 붉은 버튼:**
```jsx
<Button variant="red" size="md" label="Red Button" additionalClass="hover:bg-red-600 p-10" />
```

**조건식을 넣어준 동그란 버튼:**
```jsx
<Button size="circle" label="Circle" additionalClass={clsx({ 'bg-black text-white': isDarkMode })} />
```
